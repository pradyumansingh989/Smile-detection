...
face_cascade = cv2.CascadeClassifier('D:\CODING IDE\openCV\haarcascade_frontalface_default.xml')
smile_cascade = cv2.CascadeClassifier('D:\CODING IDE\openCV\haarcascade_smile.xml')
